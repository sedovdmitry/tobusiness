...
<html >
    <head>
        <meta charset="UTF-8">
        <title>Каталог | Электронное Снабжение</title>
        ...
        <!-- bundle style -->
        <link href="app/css/bundle.min.css" rel="stylesheet prefetch"/>
                            ...
                            <div class="uk-panel">
                                <section class="box widget weather">
                                    <article class="box post">
                                        <div class="image">
                                            <div class="uk-panel">
                                                <div class="uk-panel-badge uk-badge uk-badge-danger">Продается</div>
                                                <figure class="uk-overlay uk-overlay-hover bh-overlay-image">
                                                    <a class="uk-position-cover" href="shop-singleproduct.html"></a>
                                                    <img alt="Product Image" height="540" src="images/shop_product-07-1.jpg"
                                                        width="720">
