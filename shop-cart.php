                        ...
                        <table class="uk-table uk-table-hover uk-text-nowrap">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="shop-singleproduct.html">
                                            <img src="images/shop_product-01-1.jpg" width="100" height="75" alt="Product Image">
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="uk-text-left">
                                      <div class="uk-form-row">
                                        <div class="uk-form-controls uk-form-controls-text">
                                          <input type="radio" id="form-s-r1" name="radio1" checked> <label for="form-s-r1">Новые оригиналы</label><br>
                                          <label><input type="radio" name="radio1"> Аналоги</label><br>
                                          <label><input type="radio" name="radio1"> Восстановленные</label><br>
                                        </div>
                                      </div>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <a href="shop-singleproduct.html">
                                            <img src="images/shop_product-07-1.jpg" width="100" height="75" alt="Product Image">
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="uk-text-left">
                                      <div class="uk-form-row">
                                        <div class="uk-form-controls uk-form-controls-text">
                                          <input type="radio" id="form-s-r2" name="radio2" checked> <label for="form-s-r2">Новые оригиналы</label><br>
                                          <label><input type="radio" name="radio2"> Аналоги</label><br>
                                          <label><input type="radio" name="radio2"> Восстановленные</label><br>
                                        </div>
                                      </div>
                                    </td>
                                    <td class="uk-text-center"><a href="#"><i class="uk-icon-times"></i></a></td>
                      ...
                      <form class="uk-form uk-grid" data-uk-margin>
                        <div class="uk-width-1-1 uk-text-right">
                          <button class="uk-buttonUpdate">Обновить корзину</button>
                            <a href="shop-checkout.html" class="uk-buttonShop uk-button-primary"><i class="uk-icon-check"></i> Оформить Покупку</a>
                        </div>
                      </form>
             </section>
